...
myplot.insert_plot(MPLPlot.basic_bar, 1, data=data, height=data.AvgVelocity, colors='yellow') # Spot 1 is taken so it fills to next free
myplot.insert_plot(MPLPlot.basic_bar, 1, data=data, height=data.AvgVelocity, colors='magenta', align='edge', bottom=4) # Spot 1 is taken so it fills to next free
